...
use App\Http\Controllers\Backend\AmenitiesFeatureCategoryController;
use App\Http\Controllers\Backend\AmenitiesFeatureController;
use App\Http\Controllers\Backend\AppartmentController;
...
// Route::get('/', [BackendController::class, 'Page404'])->name('dashboard');
 ...
 Route::middleware('auth.check')->group(function () {
       Route::controller(BannerController::class)->group(function () {
           ...
           Route::get('/banner/data', 'getData')->name('banner.getData');
           Route::post('/banner/store', 'store')->name('banner.store');
           Route::get('/banner/edit/{id}', 'edit')->name('banner.edit');
           Route::post('/admin/banner/{id}', 'update')->name('banner.update');
           Route::post('/admin/banner/delete/{id}', 'destroy')->name('banner.destroy');
       });

       Route::controller(AmenitiesFeatureCategoryController::class)->group(function () {
           Route::get('/amenities/category/index', 'index')->name('amenities.category.index');
           Route::get('/amenities/category/data', 'getData')->name('AmenitiesCategory.getData');
           Route::post('/amenities/category/store', 'store')->name('amenities.category.store');
           
           Route::post('/admin/amenities-category/{id}', 'update')->name('amenities.category.update');
           Route::post('/admin/amenities-category/delete/{id}', 'destroy')->name('amenities.category.destroy');
           Route::post('/admin/amenities-category/toggle_status/{id}', 'toggleStatus')->name('amenities.category.toggleStatus');    
       });


       Route::controller(AmenitiesFeatureController::class)->group(function () {
           Route::get('/amenities/category/feature', 'index')->name('amenities.category.feature');
           Route::get('/amenities/feature/data', 'getData')->name('amenities.features.getData');
           Route::post('/amenities/feature/store', 'store')->name('amenities.feature.store');
           
           Route::post('/admin/amenities-feature/{id}', 'update')->name('amenities.feature.update');
           Route::post('/admin/amenities-feature/delete/{id}', 'destroy')->name('amenities.feature.destroy');
           Route::post('/admin/amenities-feature/toggle-status/{id}', 'toggleStatus')->name('amenities.feature.toggleStatus');    
       });


       Route::controller(AppartmentController::class)->group(function () {
           Route::get('/appartment/index', 'index')->name('appartment.index');
           Route::get('/appartment/data', 'getData')->name('appartment.getData');

           Route::get('/appartment/data/add', 'add')->name('appartment.create');
           Route::post('/appartment/store', 'store')->name('appartment.store');

           Route::get('/appartment/edit/{id}', 'edit')->name('appartment.edit');
           Route::post('/admin/appartment/{id}', 'update')->name('appartment.update');
           Route::post('/admin/appartment/delete/{id}', 'destroy')->name('appartment.destroy');
       });
 });
